...
### 2. Price Data API (Optional but Recommended)
...
- Check that the variable name is exactly `VITE_ALGO_API_TOKEN`
- Restart your development server after adding environment variables

**"Network Error" or "CORS" Issues**
- Some APIs may have CORS restrictions
- Consider using a proxy or server-side API calls for production
